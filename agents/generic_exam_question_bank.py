...
if __name__ == "__main__":
    ...
    TOPIC     = "Transform & Clean Data"        # UPSC GS-1 is flat (no topic level), keep as "All"
    ...
    # Creates a safe filename by replacing spaces with underscores and removing parentheses
    safe_name = f"{EXAM}_{SUBJECT}_{TOPIC}_{SUB_TOPIC}".replace(" ", "_").replace("(", "").replace(")", "")
